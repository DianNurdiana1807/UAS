...
if (isset($_GET['id_laporan'])) {
  ...
  $q =mysqli_query($connection,"SELECT * FROM laporan WHERE id_laporan= '$id_laporan'");
...
<div class="container-fluid">
    ...
    <div class="col-sm-10">
      ...
      <input type="hidden" class="form-control"  id="id_laporan" name="id_laporan" value="<?php echo $user["id_laporan"]; ?>">
    </div>
  </div>
  <div class="row mb-3">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
    <select name="provinsi" class="form-control" id="provinsi" value="<?php echo $user["provinsi"]; ?>">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="keahlian" name="keahlian" value="<?php echo $user["keahlian"]; ?>">
    </div>
  </div>
